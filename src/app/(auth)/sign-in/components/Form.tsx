'use client'
import { signInAction, googleSignInAction } from '@/app/(auth)/actions/auth'
...
const Form = (props: IProps) => {
  ...
  return (
    <form onSubmit={handleSubmit(signInAction)} className={cn("flex flex-col gap-6")}>
      <FieldGroup>
        ...
        <Field>
          <Button variant="outline" type="button" size='lg' onClick={googleSignInAction}>
